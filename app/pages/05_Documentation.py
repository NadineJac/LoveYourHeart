...
""")
  ...
  - [🔍 Exploratory Data Analysis (EDA)](#exploratory-data-analysis-eda)
    - [1️⃣ Class Imbalance](#class-imbalance)
    - [2️⃣ Numerical Feature Distributions](#numerical-feature-distributions)
    - [3️⃣ Categorical Feature Distributions](#categorical-feature-distributions)
    - [4️⃣ Correlation Heatmap](#correlation-heatmap)
  ...
  - [📈 Workflow Diagrams:](#workflow-diagrams)
      - [1️⃣ System Architecture Diagram](#system-architecture-diagram)
      - [2️⃣ Chatbot Workflow Diagram](#chatbot-workflow-diagram)
