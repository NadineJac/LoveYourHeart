...
if st.session_state.get("weight_value"):
    user_profile["weight_value"] = st.session_state["weight_value"]
if st.session_state.get("height_value"):
    user_profile["height_value"] = st.session_state["height_value"]
